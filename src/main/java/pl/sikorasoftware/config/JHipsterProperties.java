...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "monolit@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "monolit API";

        private String description = "monolit API documentation";
